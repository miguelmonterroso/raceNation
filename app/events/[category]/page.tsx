...
const eventData = {
  ...
  tuning: [
    ...
    { id: 2, title: "Tuning Show 2", description: "Tuning competition", date: "2024-11-20", link: "/events/tuning/car-show-diciembre", image: "https://images.unsplash.com/photo-1630357431803-abb8b18f2a48?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" },
  ],
  drift: [
