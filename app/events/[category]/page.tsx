...
const eventData = {
  ...
  tuning: [
    { id: 1, title: "Drive Fest - Diciembre", date: "1 Diciembre 2024", link: "/events/tuning/drive-fest-diciembre", image: "https://images.unsplash.com/photo-1681820819635-7912e0c94cde?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" },
    { id: 2, title: "Car Show - Diciembre", date: "1 Diciembre 2024", link: "/events/tuning/car-show-diciembre", image: "https://images.unsplash.com/photo-1630357431803-abb8b18f2a48?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" },
  ],
  drift: [
